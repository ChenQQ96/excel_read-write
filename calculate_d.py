...
# import openpyxl
# writer=pd.ExcelWriter('计算表格0905.xlsx',engine='openpyxl')
# writer.book=load_workbook('计算表格0905.xlsx')
# #指定工作表
# sheet2=writer.book["Sheet2"]
# nrows = sheet2.max_row # 获得行数
# ncolumns = sheet2.max_column # 获得列数
# print("目标sheet，行数：%d，列数：%d" %(nrows,ncolumns))
# sheet5=writer.book["Sheet5"]
# #***********************************************************#
# sheet2.cell(1,4).value = 1
# print(sheet2.cell(13,2).value)
# writer.save()
# import os
...
# writer2=openpyxl.load_workbook('临时存储.xlsx')
# sheet1=writer2["Sheet1"]
# #(0,20)
# for i in range(0,2):
#     Q_cur=Q[i]
#     #(0,19)
...
#         d_cur=sheet2_name.cell(82,23).value
...
#         #***********************************************************#
#         print(d_cur)
#         sheet1.cell(i+4,j+2).value=d_cur
#         print('保存结果')
# writer2.save('临时存储.xlsx')
